class minion_data {
    constructor() {
        ...
        minionCosts["Revenant"] = {
            ...
            5: { "REVENANT_VISCERA": 7, ...minionCostSum("Zombie", 4) },
            6: { "REVENANT_VISCERA": 7 * 2**(6 - 5), ...minionCostSum("Zombie", 5) },
            7: { "REVENANT_VISCERA": 7 * 2**(7 - 5), ...minionCostSum("Zombie", 6) },
            8: { "REVENANT_VISCERA": 7 * 2**(8 - 5), ...minionCostSum("Zombie", 7) },
            9: { "REVENANT_VISCERA": 7 * 2**(9 - 5), ...minionCostSum("Zombie", 8) },
            10: { "REVENANT_VISCERA": 7 * 2**(10 - 5), ...minionCostSum("Zombie", 9) },
            11: { "REVENANT_VISCERA": 7 * 2**(11 - 5), ...minionCostSum("Zombie", 10) },
        ...
        minionCosts["Voidling"] = {
            ...
            5: { "NULL_OVOID": 7, ...minionCostSum("Enderman", 4) },
            6: { "NULL_OVOID": 7 * 2**(6 - 5), ...minionCostSum("Obsidian", 5) },
            7: { "NULL_OVOID": 7 * 2**(7 - 5), ...minionCostSum("Enderman", 6) },
            8: { "NULL_OVOID": 7 * 2**(8 - 5), ...minionCostSum("Obsidian", 7) },
            9: { "NULL_OVOID": 7 * 2**(9 - 5), ...minionCostSum("Enderman", 8) },
            10: { "NULL_OVOID": 7 * 2**(10 - 5), ...minionCostSum("Obsidian", 9) },
            11: { "NULL_OVOID": 7 * 2**(11 - 5), ...minionCostSum("Enderman", 10) },
        };
        minionCosts["Inferno"] = {
        ...
        minionCosts["Tarantula"] = {
            ...
            5: {"TARANTULA_SILK": 7, ...minionCostSum("Spider", 4)},
            6: {"TARANTULA_SILK": 7 * 2**(6 - 5), ...minionCostSum("Spider", 5)},
            7: {"TARANTULA_SILK": 7 * 2**(7 - 5), ...minionCostSum("Spider", 6)},
            8: {"TARANTULA_SILK": 7 * 2**(8 - 5), ...minionCostSum("Spider", 7)},
            9: {"TARANTULA_SILK": 7 * 2**(9 - 5), ...minionCostSum("Spider", 8)},
            10: {"TARANTULA_SILK": 7 * 2**(10 - 5), ...minionCostSum("Spider", 9)},
            11: {"TARANTULA_SILK": 7 * 2**(11 - 5), ...minionCostSum("Spider", 10)},
